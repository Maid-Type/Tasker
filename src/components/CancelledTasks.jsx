    ...
    return (
        <>
            ...
            <div className={styles.container}>
                ...
                {state.filteredTasksArr.length > 0 ? (<Table isHeaderVisible={isHeaderVisible} tasks={state.filteredTasksArr} removeTask={removeTask} restoreTask={restoreTask} bGcolor="#3e0001"></Table>) : (
